...
* @{
*/
#define PRODUCT_KEY "f39a78f204494e12914fa12c9ea7c78a"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "9935affb41ec4cac8431304a2fe42e39"
...
#define fan_LEN                           1
#define spray_BYTEOFFSET                    0
#define spray_BITOFFSET                     1
#define spray_LEN                           1
#define sun_louver_BYTEOFFSET                    0
#define sun_louver_BITOFFSET                     2
#define sun_louver_LEN                           1
#define exhaust_air_BYTEOFFSET                    0
#define exhaust_air_BITOFFSET                     3
#define exhaust_air_LEN                           1
#define clean_BYTEOFFSET                    0
#define clean_BITOFFSET                     4
#define clean_LEN                           1
...
#define co2_ppm_MAX                           9999
#define nh3_ppm_RATIO                         1
#define nh3_ppm_ADDITION                      0
#define nh3_ppm_MIN                           0
#define nh3_ppm_MAX                           999
#define light_RATIO                         1
#define light_ADDITION                      0
#define light_MIN                           0
#define light_MAX                           999999
/**@} */
...
typedef struct {
  uint8_t flagfan:1;
  uint8_t flagspray:1;
  uint8_t flagsun_louver:1;
  uint8_t flagexhaust_air:1;
  uint8_t flagclean:1;
} attrFlags_t;
